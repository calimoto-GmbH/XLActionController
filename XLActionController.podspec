Pod::Spec.new do |spec|
  ...
  spec.authors  = { 'Miguel Revetria' => 'miguel@xmartlabs.com', 'Martin Barreto' => 'martin@xmartlabs.com', 'calimoto GmbH' => 'ios-team@calimoto.com' }
  spec.source   = { :git => 'https://github.com/calimoto-GmbH/XLActionController', :tag => spec.version }
